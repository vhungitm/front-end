import { FieldCheckGroup, FieldCheckGroupProps, FieldCheckProps, FieldFeedbackProps } from 'components/Field';
...
export const FormFieldCheckGroup = (props: FormFieldCheckGroupProps) => {
  ...
  const handleChange = (e: ChangeEvent<HTMLInputElement>) => {
    ...
    else onChange(options.length >= 2 ? value.filter((item: any) => item !== eventValue) : false);
  };
